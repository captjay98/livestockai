...
export class AwsSesProvider implements EmailProvider {
    ...
    async send(
        ...
        if (!accessKeyId || !secretAccessKey) {
            return {
                success: false,
                error: 'Missing AWS credentials (AWS_ACCESS_KEY_ID or AWS_SECRET_ACCESS_KEY)',
            }
        }
        ...
        try {
            ...
            const command = new SendEmailCommand({
                ...
                Source:
                    ...
                    'notifications@openlivestock.org',
            })
            ...
            if (error instanceof Error) {
                ...
                if (error.name === 'MessageRejected') {
                    errorMessage =
                        'Email address not verified or spam filters triggered'
                } else {
