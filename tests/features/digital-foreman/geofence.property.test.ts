...
describe('Geofence Service - Property Tests', () => {
  ...
  describe('verifyPointInCircle', () => {
    ...
    it('should verify points at the center', () => {
      fc.assert(
        fc.property(validPoint, positiveDistance, positiveDistance, (center, radius, tolerance) => {
          const result = verifyPointInCircle(center, center, radius, tolerance)
    ...
    it('should return consistent status based on distance', () => {
      fc.assert(
        fc.property(validPoint, validPoint, positiveDistance, positiveDistance, (point, center, radius, tolerance) => {
