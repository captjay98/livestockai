...
const permissionArray = fc.array(validPermission, { minLength: 0, maxLength: ALL_PERMISSIONS.length })
const invalidPermission = fc.string().filter(s => !ALL_PERMISSIONS.includes(s as ModulePermission))
...
describe('Permission Service - Property Tests', () => {
  describe('hasPermission', () => {
    ...
    it('should return true when permission exists in array', () => {
      fc.assert(
        fc.property(permissionArray, validPermission, (permissions, required) => {
    ...
    it('should handle duplicate permissions in array', () => {
      fc.assert(
        fc.property(validPermission, fc.integer({ min: 2, max: 5 }), (permission, count) => {
  ...
  describe('validatePermissions', () => {
    ...
    it('should return false when array contains invalid permission', () => {
      fc.assert(
        fc.property(permissionArray, invalidPermission, (validPerms, invalidPerm) => {
