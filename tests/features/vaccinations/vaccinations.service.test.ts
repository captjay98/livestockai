...
describe('Vaccination Service', () => {
  ...
  describe('validateVaccinationData', () => {
    ...
    it('should reject next due date before administration date', () => {
      ...
      const result = validateVaccinationData(
        { ...validData, dateAdministered: adminDate, nextDueDate: dueDate },
        'batch-1',
      )
  ...
  describe('buildVaccinationSummary', () => {
    it('should build summary correctly', () => {
      const records = [
        ...
        { nextDueDate: new Date('2020-01-01'), dateAdministered: new Date() },
        {
  ...
  describe('getUpcomingVaccinations', () => {
    it('should filter upcoming vaccinations within range', () => {
      ...
      const records = [
        { nextDueDate: new Date(today.getTime() + 2 * 24 * 60 * 60 * 1000) }, // 2 days ahead
        { nextDueDate: new Date(today.getTime() + 10 * 24 * 60 * 60 * 1000) }, // 10 days ahead
        { nextDueDate: null }, // completed
        { nextDueDate: new Date(today.getTime() - 1 * 24 * 60 * 60 * 1000) }, // overdue
      ]
