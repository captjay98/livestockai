...
describe('Batch Service', () => {
    ...
    describe('validateBatchData', () => {
        ...
        it('should reject zero or negative quantity', () => {
            expect(
                validateBatchData({ ...validData, initialQuantity: 0 }),
            ).toBe('Initial quantity must be greater than 0')
            expect(
                validateBatchData({ ...validData, initialQuantity: -10 }),
            ).toBe('Initial quantity must be greater than 0')
        })
        ...
        it('should reject target harvest date before acquisition date', () => {
            ...
            expect(result).toBe(
                'Target harvest date must be after acquisition date',
            )
        })
