...
import {
    ...
    formatCurrency,
    parseCurrency,
} from '~/features/settings/currency-formatter'
            ...
            fc.assert(
                fc.property(
                    ...
                    (amount, settings) => {
                        ...
                        const symbolCount =
                            result.split(settings.currencySymbol).length - 1
                ...
                fc.property(
                    ...
                    (amount, settings) => {
                        ...
                        if (settings.currencySymbolPosition === 'before') {
                            expect(
                                result.startsWith(settings.currencySymbol),
                            ).toBe(true)
                        } else {
                            expect(
                                result.endsWith(settings.currencySymbol),
                            ).toBe(true)
                        }
                    },
                ),
                ...
                fc.property(
                    ...
                    (amount, settings) => {
                        ...
                        if (settings.currencyDecimals === 0) {
                            ...
                            expect(
                                numberPart.includes(settings.decimalSeparator),
                            ).toBe(false)
                        } else {
            ...
            fc.assert(
                fc.property(
                    ...
                    (amount, settings) => {
                        ...
                        expect(
                            numberPart.includes(settings.thousandSeparator),
                        ).toBe(true)
                    },
                ),
                { numRuns: 100 },
