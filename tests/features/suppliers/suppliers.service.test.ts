...
describe('Suppliers Service', () => {
  ...
  describe('validateSupplierData', () => {
    ...
    it('should reject empty name', () => {
      const result = validateSupplierData(createValidSupplier({ name: '' }))
    ...
    it('should reject name exceeding 255 characters', () => {
      ...
      expect(result).toBe('Supplier name must be less than 255 characters')
    })
    ...
    it('should reject empty phone', () => {
      const result = validateSupplierData(createValidSupplier({ phone: '' }))
    ...
    it('should reject empty products array', () => {
      const result = validateSupplierData(createValidSupplier({ products: [] }))
