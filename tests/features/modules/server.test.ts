...
describe('modules/server logic', () => {
    ...
    describe('createDefaultModules logic', () => {
        ...
        it('should include matching module for single-type farms', () => {
            ...
            expect(DEFAULT_MODULES_BY_FARM_TYPE['fishery']).toContain(
                'aquaculture',
            )
                ...
                fc.property(
                    ...
                    (farmType) => {
                        const defaultModules =
                            DEFAULT_MODULES_BY_FARM_TYPE[farmType] ?? []
                        ...
                        if (defaultModules.length > 0) {
                            const enabledCount = moduleRecords.filter(
                                (m) => m.enabled,
                            ).length
