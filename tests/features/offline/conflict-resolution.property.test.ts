                ...
                fc.assert(
                    fc.property(
                        ...
                        (serverVersion, clientVersion) => {
                            ...
                            expect(conflictData?.serverVersion).toEqual(
                                serverVersion,
                            )
                            expect(conflictData?.clientVersion).toEqual(
                                clientVersion,
                            )
                            ...
                            expect(conflictData?.resolution).toBe(
                                expectedResolution,
                            )
                        },
                    ),
                ...
                fc.assert(
                    fc.property(
                        ...
                        (serverVersion, clientVersion) => {
                            ...
                            expect(metadata?.serverVersion).toEqual(
                                serverVersion,
                            )
                            expect(metadata?.clientVersion).toEqual(
                                clientVersion,
                            )
                        },
                    ),
