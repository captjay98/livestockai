...
describe('Farm Service', () => {
  ...
  describe('validateFarmRole', () => {
    it('should accept valid farm roles', () => {
      ...
      expect(validateFarmRole('worker')).toBeNull()
      expect(validateFarmRole('observer')).toBeNull()
    })
    ...
    it('should return correct error message', () => {
      const expectedError =
        'Role must be one of: owner, manager, viewer, worker, observer'
      expect(validateFarmRole('admin')).toBe(expectedError)
      expect(validateFarmRole('')).toBe(expectedError)
    })
  })
