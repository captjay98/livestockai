            ...
            fc.assert(
                fc.property(
                    ...
                    (notifications, targetUserId) => {
                        ...
                        expect(
                            filtered.every((n) => n.userId === targetUserId),
                        ).toBe(true)
                    },
                ),
                { numRuns: 100 },
            ...
            fc.assert(
                fc.property(
                    ...
                    (notifications) => {
                        ...
                        expect(markedAll.every((n) => n.read === true)).toBe(
                            true,
                        )
                    },
                ),
            ...
            fc.assert(
                fc.property(
                    ...
                    (notifications, targetUserId) => {
                        ...
                        const readCount = userNotifications.filter(
                            (n) => n.read,
                        ).length

                        expect(unreadCount + readCount).toBe(
