...
const VALID_SAME_WORDS: Record<string, Array<string>> = {
  ...
  tr: ['Broiler', 'Type', 'Layer', 'Cockerel', 'Turkey', 'Catfish', 'Tilapia'], // Total is Toplam in TR, but these are loan words
...
function checkEndingPunctuation(
  ...
  const isAmharicPunctuation = (char: string) => ['።', '፧', '፡'].includes(char)
