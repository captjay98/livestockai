...
<p align="center">
  <img src="../../public/logo-icon.png" alt="LivestockAI लोगो" width="120" />
</p>
...
| --------------------------------------------------- | ---------------------------------------------- |
| ![डैशबोर्ड](../../public/screenshots/dashboard.png) | ![बैच](../../public/screenshots/batches.png)   |
| _KPI, अलर्ट और त्वरित कार्यों के साथ फार्म अवलोकन_  | _स्थिति, प्रजाति और मृत्यु दर के साथ बैच सूची_ |

| बैच विवरण                                                | वित्तीय रिपोर्ट                                  |
| -------------------------------------------------------- | ------------------------------------------------ |
| ![बैच विवरण](../../public/screenshots/batch-details.png) | ![रिपोर्ट](../../public/screenshots/reports.png) |
| _विकास चार्ट, अनुमान और बैच समयरेखा_                     | _व्यय विवरण के साथ लाभ/हानि विश्लेषण_            |

| मोबाइल दृश्य                                             | ऑफलाइन मोड                                      |
| -------------------------------------------------------- | ----------------------------------------------- |
| ![मोबाइल](../../public/screenshots/mobile-dashboard.png) | ![ऑफलाइन](../../public/screenshots/offline.png) |
| _क्षेत्र उपयोग के लिए उत्तरदायी डिजाइन_                  | _इंटरनेट कनेक्शन के बिना काम करता है_           |

| सेटिंग्स                                           | चालान                                           |
| -------------------------------------------------- | ----------------------------------------------- |
| ![सेटिंग्स](../../public/screenshots/settings.png) | ![चालान](../../public/screenshots/invoices.png) |
