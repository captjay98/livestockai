...
[LivestockAI API Reference](../../../../modules.md) / [lib/db/types](../README.md) / Database

# Interface: Database

Defined in: lib/db/types.ts:5
...
> **batches**: [`BatchTable`](BatchTable.md)

Defined in: lib/db/types.ts:24
...
> **customers**: [`CustomerTable`](CustomerTable.md)
...
> **expenses**: [`ExpenseTable`](ExpenseTable.md)

Defined in: lib/db/types.ts:42
...
> **farms**: [`FarmTable`](FarmTable.md)

Defined in: lib/db/types.ts:17
...
> **invoices**: [`InvoiceTable`](InvoiceTable.md)
...
> **notifications**: [`NotificationTable`](NotificationTable.md)
...
> **sales**: [`SaleTable`](SaleTable.md)

Defined in: lib/db/types.ts:40
...
> **sessions**: [`SessionTable`](SessionTable.md)

Defined in: lib/db/types.ts:11
...
> **structures**: [`StructureTable`](StructureTable.md)
...
> **suppliers**: [`SupplierTable`](SupplierTable.md)
...
> **treatments**: [`TreatmentTable`](TreatmentTable.md)

Defined in: lib/db/types.ts:36
...
> **users**: [`UserTable`](UserTable.md)

Defined in: lib/db/types.ts:7
...
> **vaccinations**: [`VaccinationTable`](VaccinationTable.md)

Defined in: lib/db/types.ts:34
...
> **verification**: [`VerificationTable`](VerificationTable.md)

Defined in: lib/db/types.ts:15
