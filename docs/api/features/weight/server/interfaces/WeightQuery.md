...
[LivestockAI API Reference](../../../../modules.md) / [features/weight/server](../README.md) / WeightQuery

# Interface: WeightQuery

Defined in: features/weight/server.ts:53
...
Defined in: features/weight/server.ts:55
