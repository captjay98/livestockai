...
export const MODULE_NAVIGATION: Record<ModuleKey, Array<string>> = {
  poultry: ['Batches', 'Mortality', 'Feed', 'Weight', 'Sales', 'Health', 'Inventory'],
  aquaculture: ['Batches', 'Mortality', 'Feed', 'Weight', 'Sales', 'Health', 'Water', 'Inventory'],
  cattle: ['Batches', 'Mortality', 'Feed', 'Weight', 'Sales', 'Health', 'Inventory'],
  goats: ['Batches', 'Mortality', 'Feed', 'Weight', 'Sales', 'Health', 'Inventory'],
  sheep: ['Batches', 'Mortality', 'Feed', 'Weight', 'Sales', 'Health', 'Inventory'],
