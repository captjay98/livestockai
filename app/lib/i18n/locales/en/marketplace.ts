export const marketplace = {
  ...
  placeholders: {
    ...
    optional: 'Optional',
    farmAddress: 'Farm address or nearest landmark',
    coordinates: 'Latitude, Longitude',
    description: 'Describe your livestock, health status, feeding, etc.',
    yourEmail: 'your@email.com',
    searchSpecies: 'Search species (e.g., broiler, catfish)',
    allTypes: 'All Types',
    minPrice: 'Min',
    maxPrice: 'Max',
  },
