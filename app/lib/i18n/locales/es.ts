export const es = {
    ...
    waterQuality: {
        ...
        description:
            'Monitorear las condiciones del estanque (pH, temp, oxígeno).',
        addRecord: 'Añadir Registro',
    ...
    settings: {
        ...
        notifications: {
            ...
            waterQualityDesc:
                'Cuando pH, temp, o amoníaco están fuera de rango',
            ...
            paymentReceivedDesc:
                'Cuando las facturas son marcadas como pagadas',
            weeklySummary: 'Resumen Semanal',
            weeklySummaryDesc:
                'Resumen del rendimiento de la granja cada lunes',
        },
        business: {
        ...
        modules: {
            ...
            description:
                'Habilitar o deshabilitar tipos de ganado para su granja.',
    ...
    errors: {
        ...
        SALE_NOT_FOUND: 'Venta no encontrada',
        VALIDATION_ERROR:
            'Por favor, compruebe su entrada e inténtelo de nuevo',
        ...
        lastOwnerRemove:
            'No se puede eliminar al último propietario de una granja',
        lastOwnerDemote:
            'No se puede degradar al último propietario de una granja',
