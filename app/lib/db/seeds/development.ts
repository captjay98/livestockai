...
export async function seedDev() {
    ...
    try {
            ...
            .values([
                {
                    ...
                    message:
                        'Starter feed is below minimum threshold (25kg / 50kg)',
                    read: false,
                    actionUrl: '/inventory',
        ...
        await db
            .insertInto('farm_modules')
            .values([
                { farmId: farm2.id, moduleKey: 'aquaculture', enabled: true },
            ])
            .execute()
            ...
            .values([
                {
                    ...
                    message:
                        'Fish feed is below minimum threshold (150kg / 200kg)',
                    read: false,
                    actionUrl: '/inventory',
                    metadata: {
                        feedType: 'fish_feed',
                ...
                },
                {
                    ...
                    message:
                        'Cattle feed is below minimum threshold (300kg / 500kg)',
                    read: false,
                    actionUrl: '/inventory',
                    metadata: {
                        feedType: 'cattle_feed',
