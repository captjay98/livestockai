...
export async function up(db: Kysely<any>): Promise<void> {
    ...
    await db.schema
        ...
        .addColumn('firstDayOfWeek', 'integer', (col) =>
    ...
    await db.schema
        ...
        .addColumn('quantityBroken', 'integer', (col) =>
            col.notNull().defaultTo(0),
        )
        .addColumn('quantitySold', 'integer', (col) =>
            col.notNull().defaultTo(0),
        )
        .addColumn('createdAt', 'timestamptz', (col) =>
            col.defaultTo(sql`now()`),
    ...
    await db.schema
        ...
        .addColumn('temperatureCelsius', sql`decimal(5,2)`, (col) =>
            col.notNull(),
        )
        .addColumn('dissolvedOxygenMgL', sql`decimal(6,2)`, (col) =>
            col.notNull(),
        )
    ...
    await db.schema
        ...
        .addColumn('date', 'date', (col) => col.notNull())
        .addColumn('dosage', 'varchar(100)', (col) => col.notNull())
        .addColumn('withdrawalDays', 'integer', (col) =>
            col.notNull().defaultTo(0),
        )
        .addColumn('notes', 'text')
    ...
    await db.schema
        ...
        .addColumn('invoiceNumber', 'varchar(50)', (col) =>
            col.notNull().unique(),
        )
    ...
    await db.schema
        ...
        .addColumn('paymentStatus', 'varchar(20)', (col) =>
            col.defaultTo('paid'),
        )
  ...
  `.execute(db)
    ...
    await db.schema
        ...
        .addColumn('phosphorusPercent', sql`decimal(5,2)`, (col) =>
            col.notNull(),
        )
        .addColumn('lysinePercent', sql`decimal(5,2)`, (col) => col.notNull())
        .addColumn('methioninePercent', sql`decimal(5,2)`, (col) =>
            col.notNull(),
        )
        .addColumn('maxInclusionPercent', sql`decimal(5,2)`, (col) =>
            col.notNull(),
        )
        .addColumn('isActive', 'boolean', (col) =>
            col.notNull().defaultTo(true),
    ...
    await db.schema
        ...
        .addColumn('isAvailable', 'boolean', (col) =>
            col.notNull().defaultTo(true),
        )
        .addColumn('lastUpdated', 'timestamp', (col) =>
            col.defaultTo(sql`now()`).notNull(),
        )
        .addColumn('priceHistory', 'jsonb', (col) =>
            col.notNull().defaultTo('[]'),
        )
        .execute()
  ...
  `.execute(db)
    ...
    await db.schema
        ...
        .addColumn('requestCount', 'integer', (col) =>
    ...
    await db.schema
        ...
        .addColumn('isAnomaly', 'boolean', (col) =>
            col.notNull().defaultTo(false),
        )
        .addColumn('metadata', 'jsonb')
        .addColumn('createdAt', 'timestamptz', (col) =>
    ...
    await db.schema
        ...
        .addColumn('smsEnabled', 'boolean', (col) =>
            col.notNull().defaultTo(false),
        )
    ...
    await db.schema
        ...
        .addColumn('whiteLabel', 'boolean', (col) =>
            col.notNull().defaultTo(false),
        )
        .addColumn('createdAt', 'timestamptz', (col) =>
            col.defaultTo(sql`now()`).notNull(),
