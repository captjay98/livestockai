...
export function BatchCommandCenter({ batchId }: BatchCommandCenterProps) {
        ...
        <div className="space-y-6">
            ...
            <Dialog open={quickFeedOpen} onOpenChange={setQuickFeedOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle>{t('common:logFeed', { defaultValue: 'Log Feed Consumed' })}</DialogTitle>
                        <DialogDescription>
                    ...
                    <div className="flex justify-end gap-3">
                        <Button variant="outline" onClick={() => setQuickFeedOpen(false)}>Cancel</Button>
                        <Button onClick={() => {
                            // Submit logic here
