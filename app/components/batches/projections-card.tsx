            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground text-sm">
                        Not enough data for projections. Ensure target weight is
                        set and growth standards exist for this species.
                    </p>
                </CardContent>
            </Card>
        )
                ...
                <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                            {format(
                                new Date(projection.projectedHarvestDate),
                                'PPP',
                            )}
                        </span>
                    </div>
                    ...
                    <Progress
                        value={Math.max(
                            ...
                            Math.min(
                                100,
                                100 - (projection.daysRemaining / 60) * 100,
                            ),
