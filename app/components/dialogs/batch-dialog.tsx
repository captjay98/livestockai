...
export function BatchDialog({ open, onOpenChange }: BatchDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(
                t('messages.created', { defaultValue: 'Batch created' }),
            )
            onOpenChange(false)
                ...
                <DialogContent className="sm:max-w-md max-h-[85vh] overflow-y-auto">
                    ...
                    {!selectedFarmId && (
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                Please select a farm from the header before
                                adding a batch.
                            </AlertDescription>
                        </Alert>
                    )}
                                ...
                                {formData.species && (
                                    <p className="text-xs text-muted-foreground">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() =>
                                                setShowBreedRequestDialog(true)
                                            }
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        ...
                                        placeholder={t('notesPlaceholder', {
                                            defaultValue:
                                                'Any additional notes about this batch...',
                                        })}
                                        rows={3}
                                    />
                                </div>
