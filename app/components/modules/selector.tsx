...
export function ModuleSelector() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setError(
                err instanceof Error ? err.message : 'Failed to update modules',
            )
        } finally {
            setIsSaving(false)
        }
