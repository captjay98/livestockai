...
export function SensorList({
  ...
  const filteredSensors = sensors
    .filter(
      (sensor) => statusFilter === 'all' || sensor.status === statusFilter,
    )
    .filter(
      (sensor) =>
        structureFilter === 'all' || sensor.structureName === structureFilter,
    )
    .filter(
      (sensor) => typeFilter === 'all' || sensor.sensorType === typeFilter,
    )
    .sort((a, b) => {
