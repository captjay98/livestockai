...
export function StorageFullModal({
    ...
    const { quota, usageFormatted, quotaFormatted, refresh } =
        useStorageMonitor()
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Your device storage is almost full. Please sync your
                        data to free up space before making more changes.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Syncing will upload your pending changes to the server
