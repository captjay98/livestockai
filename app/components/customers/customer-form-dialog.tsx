    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>
            {mode === 'create'
              ? t('customers:form.addTitle', { defaultValue: 'Add Customer' })
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: string | null) =>
                setFormData((prev) => ({
                  ...prev,
                  customerType: value as CustomerFormData['customerType'],
                }))
              }
            >
              <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isSubmitting || !formData.name}>
              {isSubmitting
                ...
                : mode === 'create'
                  ? t('customers:form.create', { defaultValue: 'Add Customer' })
