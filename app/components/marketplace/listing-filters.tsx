...
export function ListingFilters({
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 p-4 bg-muted/50 rounded-lg">
            ...
            <div className="space-y-2">
                <Label>
                    {t('filters.species', { defaultValue: 'Species' })}
                </Label>
                <Input
            ...
            <div className="space-y-2">
                <Label>
                    {t('filters.minPrice', { defaultValue: 'Min Price' })}
                </Label>
                <Input
                    type="number"
                    placeholder="0"
            ...
            <div className="space-y-2">
                <Label>
                    {t('filters.maxPrice', { defaultValue: 'Max Price' })}
                </Label>
                <Input
                    type="number"
                    placeholder="10000"
            ...
            <div className="space-y-2">
                <Label>
                    {t('filters.distance', { defaultValue: 'Distance' })}
                </Label>
                <Select
