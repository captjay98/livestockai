    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 p-4 bg-muted/50 rounded-lg">
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="">{t('filters.allTypes', { defaultValue: 'All types' })}</SelectItem>
      ...
      <div className="space-y-2">
        ...
        <Input
          placeholder={t('filters.speciesPlaceholder', { defaultValue: 'e.g. broiler, catfish' })}
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="">{t('filters.anyDistance', { defaultValue: 'Any distance' })}</SelectItem>
