...
export function ContactSellerDialog({
  ...
  const [contactMethod, setContactMethod] = useState<'app' | 'phone' | 'email'>('app')
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{t('contactSeller', { defaultValue: 'Contact Seller' })}</DialogTitle>
          <DialogDescription>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="contactMethod">
              {t('contactMethod', { defaultValue: 'Contact Method' })}
            </Label>
            <Select value={contactMethod} onValueChange={(value: any) => setContactMethod(value)}>
              ...
              <SelectContent>
                <SelectItem value="app">
                  {t('throughApp', { defaultValue: 'Through App' })}
                </SelectItem>
