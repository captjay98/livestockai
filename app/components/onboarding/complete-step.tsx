...
export function CompleteStep() {
  ...
  const items = [
    ...
    progress.batchId &&
      t('complete.items.batch', { defaultValue: 'Added your first batch' }),
    t('complete.items.preferences', { defaultValue: 'Configured preferences' }),
    ...
    <div className="space-y-8 text-center">
      <div className="space-y-4">
        ...
        <h1 className="text-3xl font-bold">
          {t('complete.title', { defaultValue: "You're All Set! 🎉" })}
        </h1>
      ...
      <div className="space-y-3">
        <Button size="lg" onClick={handleComplete} disabled={isCompleting}>
          {isCompleting
            ? t('complete.finishing', { defaultValue: 'Finishing...' })
            : t('complete.submit', { defaultValue: 'Go to Dashboard' })}{' '}
