        ...
        try {
            ...
            if ('caches' in window) {
                ...
                const runtimeCaches = cacheNames.filter(
                    (name) =>
                        !name.includes('precache') && !name.includes('workbox'),
                )
                await Promise.all(
                        ...
                        <>
                            ...
                            {status === 'warning' && (
                                <div className="bg-warning/10 text-warning px-4 py-3 rounded-md text-sm">
                                    Storage is getting full. Consider syncing
                                    your data soon.
                                </div>
                            )}
                            {status === 'critical' && (
                                <div className="bg-destructive/10 text-destructive px-4 py-3 rounded-md text-sm">
                                    Storage is almost full! Please sync your
                                    data to free up space.
                                </div>
                            )}
                            {status === 'blocked' && (
                                <div className="bg-destructive/10 text-destructive px-4 py-3 rounded-md text-sm">
                                    Storage is full. You must sync your data
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    This will remove cached data to free up
                                    storage space. Your pending changes will NOT
                                    be affected. You may need to reload some
                                    data when you next access it.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
