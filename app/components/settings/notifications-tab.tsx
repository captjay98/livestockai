        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-highMortality" className="font-normal">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-lowStock" className="font-normal">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-invoiceDue" className="font-normal">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-batchHarvest" className="font-normal">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-weeklySummary" className="font-normal">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <Label htmlFor="notify-dailySales" className="font-normal">
                    Daily Sales
                  </Label>
                  <p className="text-xs text-muted-foreground">
