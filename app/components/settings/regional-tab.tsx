        ...
        <Card className="p-6 space-y-8">
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(code) => {
                                const preset = CURRENCY_PRESETS.find(
                                    (p) => p.code === code,
                                )
                                if (preset) {
                                    onSettingsChange({
                                        ...
                                        currencySymbolPosition:
                                            preset.symbolPosition,
                                        thousandSeparator:
                                            preset.thousandSeparator,
                                        decimalSeparator:
                                            preset.decimalSeparator,
                                    })
                                }
                            }}
                        >
            ...
            <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                        <Label>
                            {t('settings:regional.dateTime.timeFormat')}
                        </Label>
                        <Select
                    ...
                    <div className="space-y-2">
                        <Label>
                            {t('settings:regional.dateTime.firstDay')}
                        </Label>
                        <Select
                        ...
                        >
                            ...
                            <SelectContent>
                                <SelectItem value="0">
                                    {t(
                                        'settings:regional.dateTime.days.sunday',
                                    )}
                                </SelectItem>
                                <SelectItem value="1">
                                    {t(
                                        'settings:regional.dateTime.days.monday',
                                    )}
                                </SelectItem>
                                <SelectItem value="6">
                                    {t(
                                        'settings:regional.dateTime.days.saturday',
                                    )}
                                </SelectItem>
                            </SelectContent>
                        </Select>
