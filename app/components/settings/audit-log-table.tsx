            ...
            <div className="rounded-md border bg-card">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>
                                {t('settings.audit.table.date')}
                            </TableHead>
                            <TableHead>
                                {t('settings.audit.table.user')}
                            </TableHead>
                            <TableHead>
                                {t('settings.audit.table.action')}
                            </TableHead>
                            <TableHead>
                                {t('settings.audit.table.entity')}
                            </TableHead>
                            <TableHead>
                                {t('settings.audit.table.details')}
                            </TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
