...
export function WorkerList({
  ...
  return (
    <>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {onEditWorker && (
                            <DropdownMenuItem
                              onClick={() => onEditWorker(worker.userId)}
                            >
      ...
      <AlertDialog
        open={!!workerToRemove}
        onOpenChange={() => setWorkerToRemove(null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Remove Worker</AlertDialogTitle>
            <AlertDialogDescription>
              Are you sure you want to remove {workerToRemove?.name} from this
              farm? Their historical data will be preserved.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() =>
                ...
                removeWorker.mutate({
                  data: {
                    profileId: workerToRemove.profileId,
                  },
                })
              }
            >
