...
} from '~/features/digital-foreman/server'
...
export function WorkerProfileForm({
    ...
    const [wageRateAmount, setWageRateAmount] = useState(
        existingProfile?.wageRateAmount || '',
    )
    const [wageRateType, setWageRateType] = useState<
        'hourly' | 'daily' | 'monthly'
    >(existingProfile?.wageRateType || 'daily')
        ...
        if (existingProfile) {
            update.mutate({
                data: {
                    ...
                    phone,
                    wageRateAmount: Number(wageRateAmount),
                    wageRateType,
                    permissions,
                },
            })
    ...
    const applyTemplate = (templateKey: string) => {
        const template =
            PERMISSION_TEMPLATES[
                templateKey as keyof typeof PERMISSION_TEMPLATES
            ]
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Select
                            value={wageRateType}
                            onValueChange={(v) => v && setWageRateType(v)}
                        >
                            <SelectTrigger>
                                <SelectValue />
                            </SelectTrigger>
                ...
                <div>
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectItem value="feed_handler">
                                Feed Handler
                            </SelectItem>
                            <SelectItem value="health_monitor">
                                Health Monitor
                            </SelectItem>
                            ...
                            >
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) =>
                                        handleCheckboxChange(perm, checked)
                                    }
                                />
                                {perm}
                            </label>
