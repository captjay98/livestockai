...
export function NavSection({
  ...
  return (
    ...
    >
      <CollapsibleTrigger className="flex items-center justify-between w-full px-3 py-2 text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest hover:text-foreground/80 transition-colors">
        {title}
