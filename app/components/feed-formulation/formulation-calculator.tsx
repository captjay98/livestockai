                ...
                <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent>
                                    {species &&
                                        STAGE_OPTIONS[
                                            species as keyof typeof STAGE_OPTIONS
                                        ].map((option) => (
                                            <SelectItem
                                                key={option.value}
                                                value={option.value}
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            onChange={(e) =>
                                setMixingInstructions(e.target.value)
                            }
                            placeholder={t(
                                'calculator.mixingInstructionsPlaceholder',
                                {
                                    defaultValue:
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            {result.feasible
                                ? t('results.optimal', {
                                      defaultValue: 'Optimal Formulation',
                                  })
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="text-center">
                                        <div className="text-2xl font-bold">
                                            {format(
                                                parseFloat(batchSize || '100') *
                                                    result.totalCostPerKg,
                                            )}
                                        </div>
                                        <div className="text-sm text-muted-foreground">
                                            Total batch cost
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="text-center p-3 bg-muted rounded-lg">
                                            <div className="text-lg font-bold">
                                                {result.nutritionalValues.protein.toFixed(
                                                    1,
                                                )}
                                                %
                                            </div>
                                        ...
                                        <div className="text-center p-3 bg-muted rounded-lg">
                                            <div className="text-lg font-bold">
                                                {result.nutritionalValues.energy.toFixed(
                                                    0,
                                                )}
                                            </div>
                                            <div className="text-sm text-muted-foreground">
                                        ...
                                        <div className="text-center p-3 bg-muted rounded-lg">
                                            <div className="text-lg font-bold">
                                                {result.nutritionalValues.fiber.toFixed(
                                                    1,
                                                )}
                                                %
                                            </div>
                                        ...
                                        <div className="text-center p-3 bg-muted rounded-lg">
                                            <div className="text-lg font-bold">
                                                {result.nutritionalValues.fat.toFixed(
                                                    1,
                                                )}
                                                %
                                            </div>
