                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                {onSelectForComparison && (
                                                    ...
                                                    >
                                                        ...
                                                        {t(
                                                            'savedFormulations.addToComparison',
                                                            {
                                                                defaultValue:
                                                                    'Add to Comparison',
                                                            },
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                <div className="text-center p-3 bg-muted rounded-lg">
                                    <div className="text-2xl font-bold">
                                        {format(
                                            formulationDetail.totalCostPerKg,
                                        )}
                                    </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {formulationDetail.ingredients.map(
                                        (ingredient: any) => (
                                            <div
                                                key={ingredient.id}
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    <div className="font-medium">
                                                        {ingredient.quantity.toFixed(
                                                            2,
                                                        )}
                                                        kg (
                                                        {ingredient.percentage.toFixed(
                                                            1,
                                                        )}
                                                        %)
                                                    </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div className="text-center p-3 bg-muted rounded-lg">
                                        <div className="text-lg font-bold">
                                            {formulationDetail.nutritionalValues.protein.toFixed(
                                                1,
                                            )}
                                            %
                                        </div>
                                    ...
                                    <div className="text-center p-3 bg-muted rounded-lg">
                                        <div className="text-lg font-bold">
                                            {formulationDetail.nutritionalValues.energy.toFixed(
                                                0,
                                            )}
                                        </div>
                                        <div className="text-sm text-muted-foreground">
                                    ...
                                    <div className="text-center p-3 bg-muted rounded-lg">
                                        <div className="text-lg font-bold">
                                            {formulationDetail.nutritionalValues.fiber.toFixed(
                                                1,
                                            )}
                                            %
                                        </div>
                                    ...
                                    <div className="text-center p-3 bg-muted rounded-lg">
                                        <div className="text-lg font-bold">
                                            {formulationDetail.nutritionalValues.fat.toFixed(
                                                1,
                                            )}
                                            %
                                        </div>
                            ...
                            {formulationDetail.mixingInstructions && (
                                <div>
                                    <h4 className="font-medium mb-3">
                                        {t(
                                            'savedFormulations.mixingInstructions',
                                            {
                                                defaultValue:
                                                    'Mixing Instructions',
                                            },
