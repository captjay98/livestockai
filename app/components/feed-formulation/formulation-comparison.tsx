                                                ...
                                                {formulation.costDifference && (
                                                    <div className="mt-2 text-sm">
                                                        ...
                                                        >
                                                            ...
                                                            (
                                                            {formulation.costDifferencePercent >
                                                            0
                                                                ? '+'
                                                                : ''}
                                                            {formulation.costDifferencePercent.toFixed(
                                                                1,
                                                            )}
                                                            %) vs most
                                                            cost-effective
                    ...
                    <CardContent className="text-center py-8">
                        ...
                        <p className="text-muted-foreground">
                            {t('comparison.selectAtLeastTwo', {
                                defaultValue:
                                    'Select at least 2 formulations to compare',
                            })}
                        </p>
                    </CardContent>
                </Card>
