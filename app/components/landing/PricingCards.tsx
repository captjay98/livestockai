...
const colorMap = {
    ...
    purple: 'from-purple-500/20 to-pink-500/20 text-purple-600 dark:text-purple-400 border-purple-500/30 glow-purple',
    amber: 'from-amber-500/20 to-orange-500/20 text-amber-600 dark:text-amber-400 border-amber-500/30 glow-amber',
}
        ...
        >
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                <div className="mt-20 flex flex-col items-center justify-center text-center opacity-40 hover:opacity-100 transition-opacity">
                    ...
                    >
                        All pricing tiers are subject to network governance.{' '}
                        <br />
                        Managed cloud includes 256-bit encryption & localized
                        persistence.
                    </p>
                </div>
            </div>
