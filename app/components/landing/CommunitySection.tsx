            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
                    ...
                    <div className="flex-1 text-left">
                        ...
                        >
                            OpenLivestock is more than software; it's a
                            movement. Built by farmers and developers working
                            together to democratize agricultural technology.
                        </p>
                    ...
                    <div className="flex-1 w-full lg:min-w-[500px]">
                        ...
                        <div className="mt-8 flex gap-1 justify-center opacity-20 mask-gradient-b">
                            {Array.from({ length: 30 }).map((_col, colIdx) => (
                                <div
                                    key={colIdx}
