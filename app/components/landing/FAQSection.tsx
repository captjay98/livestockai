...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Absolutely. OpenLivestock is open-source under the FSL license, converting to Apache 2.0 after 2 years. You can self-host without any licensing fees, ever.',
    },
    {
        question: 'What payment methods do you accept?',
        answer: 'We accept all major credit cards, debit cards, bank transfers, and mobile money through Paystack. For Nigerian users, we also support USSD payments.',
    },
    {
        question: 'Do you offer refunds?',
        answer: "Yes. We offer a 14-day money-back guarantee for all paid plans. If you're not satisfied, contact support for a full refund.",
    },
    {
        question: 'Can I migrate from self-hosted to managed cloud?',
        answer: 'Yes! We provide migration tools and support to help you move your data from self-hosted to our managed cloud seamlessly. Contact our support team for assistance.',
    },
]
