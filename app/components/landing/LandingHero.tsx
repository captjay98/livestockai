            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 w-full max-w-[1400px] z-10 mr-auto ml-auto relative gap-x-12 gap-y-12 items-end">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-neutral-600 dark:text-neutral-600/50">
                            •
                        </span>
                    ...
                    >
                        ...
                        >
                            AI-powered livestock management with predictive
                            analytics, smart recommendations, and autonomous
                            monitoring. Supports 6+ species with offline-first
                            architecture. Self-host or use our managed cloud.
                        </span>
                    </p>
