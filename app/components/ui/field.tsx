...
function FieldSet({ className, ...props }: React.ComponentProps<"fieldset">) {
  return (
    <fieldset
      data-slot="field-set"
      className={cn("gap-5 has-[>[data-slot=checkbox-group]]:gap-4 has-[>[data-slot=radio-group]]:gap-4 flex flex-col", className)}
      {...props}
    />
  )
}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-muted-foreground text-left text-sm/relaxed [[data-variant=legend]+&]:-mt-2 leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance",
