    ...
    <section className="min-h-[60vh] flex flex-col justify-center w-full pt-40 pb-20 px-6 lg:px-12 relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-[1400px] mx-auto text-center relative z-10">
        ...
        >
          ...
          <span className="block text-emerald-500">Farm Management</span>
        </h1>
        ...
        >
          Everything you need to manage modern livestock operations. From
          predictive analytics to multi-species support.
        </p>
      </div>
    </section>
  )
