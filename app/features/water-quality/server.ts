...
export const updateReadingFn = createServerFn({ method: 'POST' })
    ...
    .handler(async ({ data: input }) => {
        ...
        try {
            ...
            if (input.data.ph !== undefined)
                updateData.ph = input.data.ph.toString()
            if (input.data.temperatureCelsius !== undefined)
                updateData.temperatureCelsius =
                    input.data.temperatureCelsius.toString()
            if (input.data.dissolvedOxygenMgL !== undefined)
                updateData.dissolvedOxygenMgL =
                    input.data.dissolvedOxygenMgL.toString()
