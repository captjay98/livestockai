...
export function useWaterQualityPage({
    ...
    const handleAddSubmit = async (data: {
        ...
        try {
                ...
                data: {
                    ...
                    data: {
                        ...
                        dissolvedOxygenMgL: parseFloat(
                            String(data.dissolvedOxygenMgL),
                        ),
            ...
            toast.success(
                t('waterQuality:recorded', {
                    defaultValue: 'Water quality recorded',
                }),
            )
    ...
    const handleEditSubmit = async (data: {
        ...
        try {
            ...
            toast.success(
                t('common:updated', { defaultValue: 'Record updated' }),
            )
            await router.invalidate()
        } finally {
            setIsSubmitting(false)
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            toast.success(
                t('common:deleted', { defaultValue: 'Record deleted' }),
            )
            await router.invalidate()
        } finally {
            setIsSubmitting(false)
