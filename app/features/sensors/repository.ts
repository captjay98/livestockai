...
export async function insertSensor(db: Kysely<Database>, data: SensorInsert): Promise<string> {
...
export async function getSensorsByFarm(db: Kysely<Database>, farmIds: Array<string>) {
  return db
    .selectFrom('sensors')
...
export async function getSensorByApiKeyHash(db: Kysely<Database>, apiKeyHash: string) {
  return db
    .selectFrom('sensors')
    .select([
      'id',
...
export async function updateSensor(db: Kysely<Database>, id: string, data: SensorUpdate) {
  await db
    .updateTable('sensors')
    .set(data)
    .where('id', '=', id)
...
export async function getSensorSummaryByFarm(db: Kysely<Database>, farmId: string) {
