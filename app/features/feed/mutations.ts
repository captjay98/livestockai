 ...
 */
export interface CreateFeedMutationInput {
  farmId: string
 ...
 */
export interface UpdateFeedMutationInput {
  farmId: string
  recordId: string
 ...
 */
export interface DeleteFeedMutationInput {
  farmId: string
  recordId: string
}
...
export function useFeedMutations(): UseFeedMutationsResult {
  ...
  >({
    ...
    onSettled: () => {
      ...
      queryClient.invalidateQueries({ queryKey: FEED_QUERY_KEYS.summary() })
      queryClient.invalidateQueries({ queryKey: FEED_QUERY_KEYS.inventory() })
    },
  })
