...
function parseSolution(
    ...
    const nutritionalValues = {
        protein: ingredients.reduce(
            (sum, ing, i) =>
                sum + (ing.proteinPercent * getPercentage(i)) / 100,
            0,
        ),
        ...
        calcium: ingredients.reduce(
            (sum, ing, i) =>
                sum + (ing.calciumPercent * getPercentage(i)) / 100,
            0,
        ),
        phosphorus: ingredients.reduce(
            (sum, ing, i) =>
                sum + (ing.phosphorusPercent * getPercentage(i)) / 100,
            0,
        ),
        ...
        methionine: ingredients.reduce(
            (sum, ing, i) =>
                sum + (ing.methioninePercent * getPercentage(i)) / 100,
            0,
        ),
    }
