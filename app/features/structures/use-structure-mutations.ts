...
export function useStructureMutations(): UseStructureMutationsResult {
    ...
    >({
        ...
        onMutate: async ({ structure }) => {
            ...
            const previousStructures = getQueryData<
                Array<StructureCacheRecord>
            >(queryClient, STRUCTURE_QUERY_KEYS.all)
        ...
        onSuccess: async (serverId, { structure }, context) => {
            if (context.tempId) {
                ...
                const currentStructures = getQueryData<
                    Array<StructureCacheRecord>
                >(queryClient, STRUCTURE_QUERY_KEYS.all)
    ...
    >({
        ...
        onMutate: async ({ structureId }) => {
            ...
            const previousStructures = getQueryData<
                Array<StructureCacheRecord>
            >(queryClient, STRUCTURE_QUERY_KEYS.all)
            const updatedStructures = removeById(
                previousStructures,
                structureId,
            )
            setQueryData(
