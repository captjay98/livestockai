...
function FeedFormulationPage() {
  ...
  const handleSelectForComparison = (formulationId: string) => {
    if (!comparisonFormulations.includes(formulationId)) {
      setComparisonFormulations((prev) => [...prev, formulationId].slice(0, 3))
    }
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">
          {t('title', { defaultValue: 'Feed Formulation Calculator' })}
        </h1>
      ...
      >
        <TabsList className="grid w-full grid-cols-4">
          ...
          >
            ...
            <span className="hidden sm:inline">
              {t('tabs.calculator', { defaultValue: 'Calculator' })}
            </span>
          </TabsTrigger>
          <TabsTrigger value="prices" className="flex items-center gap-2 h-12">
          ...
          <TabsTrigger value="saved" className="flex items-center gap-2 h-12">
        ...
        <TabsContent value="calculator" className="space-y-6">
          <FormulationCalculator onSaveFormulation={handleSaveFormulation} />
        </TabsContent>
