...
import type { CreateBatchData } from '~/features/batches/server'
...
const createBatchAction = createServerFn({ method: 'POST' })
  .inputValidator(
    (
      data: Omit<CreateBatchData, 'acquisitionDate' | 'targetHarvestDate'> & {
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: string | null) =>
                  value && handleLivestockTypeChange(value)
                }
              >
                <SelectTrigger>
                  <SelectValue>
