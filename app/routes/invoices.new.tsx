...
const fetchFormData = createServerFn({ method: 'GET' }).handler(async () => {
  const [customers, farms] = await Promise.all([
    getCustomers(),
    getFarms(),
  ])
    ...
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl">
          <h1 className="text-3xl font-bold tracking-tight mb-8">Create Invoice</h1>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {items.map((item, index) => (
                  <div key={index} className="grid gap-3 md:grid-cols-12 items-end p-4 bg-muted/50 rounded-lg">
