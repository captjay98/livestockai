...
function VerificationPage() {
  ...
  const getStatusIcon = () => {
    if (isExpired) return <AlertTriangle className="h-8 w-8 text-yellow-500" />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-600">
                    {report.publicMetrics.creditScore || 'N/A'}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Grade: {report.publicMetrics.creditGrade || 'Unrated'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {report.publicMetrics.productionCapacity || 'N/A'}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Units per cycle
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-blue-600">
                    {report.publicMetrics.sustainabilityScore || 'N/A'}
                  </div>
                  <p className="text-xs text-muted-foreground">
