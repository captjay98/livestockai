...
function FarmDetailsPage() {
  const { farm, stats } = Route.useLoaderData()
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Button variant="outline" className="h-auto p-4 w-full glass">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    View and manage livestock batches
                  </div>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/sales/new" search={{ farmId }} className="w-full">
              <Button
                variant="outline"
                className="h-auto p-4 w-full glass text-emerald-600"
              >
                <div className="text-center">
            ...
            <Link to="/expenses/new" search={{ farmId }} className="w-full">
              <Button
                variant="outline"
                className="h-auto p-4 w-full glass text-destructive"
              >
                <div className="text-center">
            ...
            <Link to="/reports" search={{ farmId }} className="w-full">
              <Button
                variant="outline"
                className="h-auto p-4 w-full glass text-blue-600"
              >
                <div className="text-center">
