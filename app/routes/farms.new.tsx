    ...
    <div className="container mx-auto py-6 px-4 max-w-2xl">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Add a new farm to your management system</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Enter the basic information for your new farm</CardDescription>
        </CardHeader>
        <CardContent>
