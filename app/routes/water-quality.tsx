...
import { AlertTriangle, Droplets, Edit, Eye, Plus, Trash2 } from 'lucide-react'
...
interface WaterQualityData {
  records: Array<WaterQualityRecord>
    ...
    <div className="container mx-auto py-6 px-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="temperatureCelsius">
                  Temperature °C (Safe: {t.temperature.min} -{' '}
                  {t.temperature.max})
                </Label>
                <Input
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Optimal water quality parameters for fish
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-3 sm:gap-4 grid-cols-2 md:grid-cols-4">
            ...
            <div className="p-2 sm:p-3 bg-muted rounded-md">
              ...
              <p className="text-base sm:text-lg">
                {t.temperature.min}°C - {t.temperature.max}°C
              </p>
            </div>
            <div className="p-2 sm:p-3 bg-muted rounded-md">
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Start monitoring your pond water
            </p>
            ...
            <div className="space-y-4">
              {records.map((record) => {
                ...
                const hasIssue =
                  ph < t.ph.min ||
                  ph > t.ph.max ||
                  temp < t.temperature.min ||
                  temp > t.temperature.max ||
                ...
                return (
                  <div
                    key={record.id}
                    className={`p-3 sm:p-4 border rounded-lg ${hasIssue ? 'border-warning' : ''}`}
                  >
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div>
                        ...
                        <p
                          className={`font-medium ${ph < t.ph.min || ph > t.ph.max ? 'text-warning' : ''}`}
                        >
                          {ph.toFixed(1)}
                        </p>
                      </div>
                      <div>
                        ...
                        <p
                          className={`font-medium ${temp < t.temperature.min || temp > t.temperature.max ? 'text-warning' : ''}`}
                        >
                          {temp.toFixed(1)}°C
                        </p>
                      </div>
                      <div>
                        ...
                        <p
                          className={`font-medium ${oxygen < t.dissolvedOxygen.min ? 'text-warning' : ''}`}
                        >
                      ...
                      <div>
                        ...
                        <p
                          className={`font-medium ${ammonia > t.ammonia.max ? 'text-warning' : ''}`}
                        >
